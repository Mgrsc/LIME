...
import org.bitfennec.lime.view.preference.DialogSeekBarPreference
import org.bitfennec.lime.view.preference.EditTextIntPreference
import org.bitfennec.lime.view.preference.ImeSwitchPreference
import org.bitfennec.lime.view.preference.ManagedPreference
import org.bitfennec.lime.view.preference.TwinSeekBarPreference
...
abstract class ManagedPreferenceUi<T : Preference>(
    ...
    class SeekBarInt(
        ...
        override fun createUi(context: Context) = DialogSeekBarPreference(context).apply {
            ...
            unit = this@SeekBarInt.unitRes?.let { context.getString(it) } ?: this@SeekBarInt.unit
