...
abstract class ManagedPreference<T : Any>(
    ...
    class PLong(sharedPreferences: SharedPreferences, key: String, defaultValue: Long) :
        ManagedPreference<Long>(sharedPreferences, key, defaultValue) {
