...
internal fun keyboardPopupLabels(label: String, smallLabel: String): Array<String> {
    val labels = (PopupSmallPreset[smallLabel] ?: emptyArray()) + (PopupPreset[label] ?: emptyArray())
    return labels.ifEmpty { PopupPreset[smallLabel] ?: emptyArray() }
}
